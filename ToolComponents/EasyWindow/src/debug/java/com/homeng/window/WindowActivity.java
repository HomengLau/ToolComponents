...
import com.homeng.permissions.OnPermissionCallback;
import com.homeng.permissions.Permission;
import com.homeng.permissions.XXPermissions;
import com.homeng.toast.Toaster;
import com.homeng.window.draggable.MovingDraggable;
import com.homeng.window.draggable.SpringBackDraggable;
 ...
 *    desc   : Demo 使用案例
 */
public final class WindowActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (viewId == R.id.btn_main_anim) {
            ...
            XXPermissions.with(WindowActivity.this)
                    ...
                    .request(new OnPermissionCallback() {
                        ...
                        public void onDenied(@NonNull List<String> permissions, boolean doNotAskAgain) {
                            EasyWindow.with(WindowActivity.this)
                                    .setDuration(1000)
                                    .setContentView(R.layout.window_hint)
                                    .setImageDrawable(android.R.id.icon, R.drawable.ic_dialog_tip_error)
